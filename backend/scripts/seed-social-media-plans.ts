...
async function main() {
  ...
  const plans = [
    ...
    },
    {
      ...
      currentPlanEndDate: new Date('2026-02-05').toISOString(),
      newPlanStartDate: new Date('2026-02-07').toISOString(),
      briefDeadline: new Date('2025-12-15').toISOString(), // 15 Aralık Pazartesi (2025)
    ...
    },
    {
      ...
      briefDeadline: new Date('2025-12-15').toISOString(),
      presentationDeadline: new Date('2025-12-26').toISOString(), // 26 Aralık Cuma (2025)
      briefStatus: 'Bekliyor',
      designStatus: 'Bekliyor',
      socialMediaManager: 'ECEM',
      designer: 'İbrahim Alp',
    ...
    },
    {
      ...
      briefDeadline: new Date('2026-01-15').toISOString(),
      presentationDeadline: new Date('2026-01-12').toISOString(), // 12 Ocak Pazartesi (2026)
      briefStatus: 'Çalışılıyor',
      designStatus: 'Bekliyor',
      socialMediaManager: 'TUĞÇE',
      designer: 'Bahar',
  ...
  // Clear existing plans to avoid duplicates if re-run (optional, but safer for dev)
