...
export declare class ProjectsService {
    ...
    constructor(prisma: PrismaService, chatService: ChatService, tasksService: TasksService, notificationsService?: NotificationsService | undefined);
    ...
    create(tenantId: string, data: any, user?: any): Promise<{
        id: string;
        name: string;
        tenantId: string;
        customerId: string;
