...
export declare class ChatService {
    ...
    listMessages(tenantId: string, user: any, roomId: string, cursor?: string, limit?: number): Promise<{
        id: string;
        tenantId: string;
        createdAt: Date;
        status: string;
    ...
    syncInstagramMessages(tenantId: string, roomId: string): Promise<any[]>;
    private sendInstagramMessage;
    createTaskFromMessage(tenantId: string, user: any, messageId: string): Promise<{
        id: string;
        tenantId: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    markMessagesAsRead(tenantId: string, user: any, roomId: string, messageIds: string[]): Promise<string[] | undefined>;
    markMessagesAsDelivered(tenantId: string, user: any, roomId: string, messageIds: string[]): Promise<string[] | undefined>;
}
